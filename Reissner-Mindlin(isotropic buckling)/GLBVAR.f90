...
!	Material Coefficients
	...
	REAL*8, PARAMETER :: L1=1.0D0	! WIDTH OF THE PLATE											
	REAL*8, PARAMETER :: L2=1.0D0	! LENGTH OF THE PLATE											
	REAL*8, PARAMETER :: h=0.20D0	! THICKNESS OF THE PLATE
...
!	REAL*8, PARAMETER :: KS=0.8220D0		! SHEAR CORRECTION FACTOR
	...
	REAL*8, DIMENSION(1:3), PARAMETER :: STRESS_N=(/1.0D0, 0.D0, 0.D0/)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
