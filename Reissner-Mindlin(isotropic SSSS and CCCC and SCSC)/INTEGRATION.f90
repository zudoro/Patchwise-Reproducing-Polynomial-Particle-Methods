...
REAL*8 FUNCTION INTEGRATION_K(BGMESH_I, BGMESH_J, SF_INDX_I, SF_INDX_J, INTPATCHES, &
	...
	!--------------------EVALUATE PU AND SF AT EACH GAUSS POINT----------------
		    CALL PHYSF(SF_I, GSPT(:)%PT, SF_INDX_I, OMEGA.AND.(BGMESH_I+DELTA))
		    CALL PHYSF(SF_J, GSPT(:)%PT, SF_INDX_J, OMEGA.AND.(BGMESH_J+DELTA))
	...
	!--------------------EVALUATE INTEGRAND AT EACH GAUSS POINT IN SUBMATRIX-----------
			DIFF_NX = DOT_PRODUCT(PRODUCT(RESHAPE((/PU_j(:)%D00, SF_j(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2), &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D10, SF_i(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2) + &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D00, SF_i(:)%D10/), (/N**2, 2/), ORDER=ORDER1), 2))
	...
	!--------------------EVALUATE INTEGRAND AT EACH GAUSS POINT IN SUBMATRIX-----------
			DIFF_NY = DOT_PRODUCT(PRODUCT(RESHAPE((/PU_j(:)%D00, SF_j(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2), &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D01, SF_i(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2) + &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D00, SF_i(:)%D01/), (/N**2, 2/), ORDER=ORDER1), 2))
	...
	!--------------------EVALUATE INTEGRAND AT EACH GAUSS POINT IN SUBMATRIX-----------
			DIFF_YX = DOT_PRODUCT(PRODUCT(RESHAPE((/PU_j(:)%D01, SF_j(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2) + &
								  PRODUCT(RESHAPE((/PU_j(:)%D00, SF_j(:)%D01/), (/N**2, 2/), ORDER=ORDER1), 2),  &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D10, SF_i(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2) + &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D00, SF_i(:)%D10/), (/N**2, 2/), ORDER=ORDER1), 2))

			DIFF_XY = DOT_PRODUCT(PRODUCT(RESHAPE((/PU_j(:)%D10, SF_j(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2) + &
								  PRODUCT(RESHAPE((/PU_j(:)%D00, SF_j(:)%D10/), (/N**2, 2/), ORDER=ORDER1), 2),  &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D01, SF_i(:)%D00/), (/N**2, 2/), ORDER=ORDER1), 2) + &
					  			  PRODUCT(RESHAPE((/PU_i(:)%D00, SF_i(:)%D01/), (/N**2, 2/), ORDER=ORDER1), 2))
