...
TYPE(RECPATCH), INTENT(INOUT) :: OMEGA
    ...
    IF (PROBLEM.EQ.0) THEN
		OMEGA%PT1=POINT2D(-0.50D0*L*PI, 0.0D0)
		OMEGA%PT2=POINT2D(0.50D0*L*PI, 0.0D00)
		OMEGA%PT3=POINT2D(0.50D0*L*PI, 1.59362426004003990D0)
		OMEGA%PT4=POINT2D(-0.50D0, 1.59362426004003990D0)
	ELSEIF (PROBLEM.EQ.1) THEN
				OMEGA%PT1=POINT2D(-0.50D0*L*PI, 0.0D0)
		OMEGA%PT2=POINT2D(0.50D0*L*PI, 0.0D00)
		OMEGA%PT3=POINT2D(0.50D0*L*PI, 1.59093906326468160D0)
		OMEGA%PT4=POINT2D(-0.50D0, 1.59093906326468160D0)

    ELSEIF (PROBLEM.EQ.2) THEN
    	OMEGA%PT1=POINT2D(-PI, 0.0D0)
    	OMEGA%PT2=POINT2D(PI, 0.0D0)
    	OMEGA%PT3=POINT2D(PI, PI)
    	OMEGA%PT4=POINT2D(-PI, PI)
