...
!	Material Coefficients
	...
	CHARACTER(LEN=4), PARAMETER :: BCTYPE = 'HARD' ! CLAM - CLAMPED(FIXED), HARD - HARD SIMPLY SUPPORTED
											! SOFT - SOFT SIMPLY SUPPORTED, FREE - JUST FREE
														
	REAL*8, PARAMETER :: L=1.0D0	! LENGTH OF THE PLATE ALONG X-AXIS 	
	REAL*8, PARAMETER :: h=0.1D0	! (d) THICKNESS OF THE PLATE
	...
	REAL*8, DIMENSION(1:2), PARAMETER :: E=2.0D0*10**(7)*(/1.0D0, 1.0D0/) 	! YOUNG'S MODULUS {E1, E2}, STEEL
	REAL*8, DIMENSION(1:2), PARAMETER :: V=3.0D0*(/1.0D0, 1.0D0/)		! POISSON RATION {V12, V21}
