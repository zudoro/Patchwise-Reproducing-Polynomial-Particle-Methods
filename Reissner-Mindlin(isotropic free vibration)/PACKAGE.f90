...
SUBROUTINE APNONDIMRESULT(W_BAR_CENTER, W_HAT, W0, NUMGRID)
	REAL*8, INTENT(IN) :: W0(:)
	INTEGER, INTENT(IN) :: NUMGRID(2)
	REAL*8, INTENT(OUT) :: W_BAR_CENTER, W_HAT
	REAL*8 :: LENGTH_B
	INTEGER :: INDICE(1)
	...
	DO I=1, NUM_XCORDS
		DO J=1, NUM_YCORDS
			...
			DO II=1, DOF
				...
				SF(II) = PHYSF2D(POINT2D(XCORDS(I), YCORDS(J)), INT2D(NDX(2,II),NDX(3,II)), & 
